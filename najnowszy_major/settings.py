"""
Django settings for najnowszy_major project.
...
BASE_DOMAINS = ['127.0.0.1', '165.227.133.227']
...
ROOT_URLCONF = 'najnowszy_major.urls'
...
WSGI_APPLICATION = 'najnowszy_major.wsgi.application'
